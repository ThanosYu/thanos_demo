...
/**
 * <br>
 * 经测试对象大小达到3678071byte（3678071byte大概是包含两个字符串类型属性（字符串长度在10以内）的对象，可以达到10W个的数量） 传输正常<br>
 */
@Service
public class RedisCachePlugin implements CachePlugin {

    private static Log log = LogFactory.getLog(CachePlugin.class);
