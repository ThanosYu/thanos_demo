...
public class StrUtil {
	...
	public static void main(String[] args) throws IOException {
        File file = new File("E:\\QLDownload\\webapps\\asus-logo.jpg");
//        BASE64Encoder encoder = new BASE64Encoder();
//        encoder.encode(new FileInputStream(file) , new FileOutputStream("E:\\QLDownload\\webapps\\asus-logo.txt"));
        BASE64Decoder decoder = new BASE64Decoder();
        decoder.decodeBuffer(new FileInputStream("E:\\QLDownload\\webapps\\8.txt") , new FileOutputStream("E:\\QLDownload\\webapps\\8.jpg"));


        Console.info(encodeMD5("123123"));
	}
}
